...
@section('content')
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Create Single Menu</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                    ...
                    <pre id="register">if(function_exists('register_nav_menu'))
{
    register_nav_menu('<span id="singid">main-menu</span>',__('<span id="singdesc">Main Menu</span>','<span id="singdom">tweentyseven</span>'));
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2>Register Multiple Menus</h2>
                    <pre id="registernavmenus">if(function_exists('register_nav_menus'))
{
    register_nav_menus( array(
<span id="multimenu"></span>    ) );
}</pre>
                </div>
            </div>
            <div class="row">
